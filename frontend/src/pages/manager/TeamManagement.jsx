          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="border-b border-slate-200 bg-slate-50">
                <tr>
                  <th className="px-5 py-4 text-left text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Team Name</th>
                  <th className="px-5 py-4 text-left text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Team Head</th>
                  <th className="px-5 py-4 text-left text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Department</th>
                  <th className="px-5 py-4 text-center text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Members</th>
                  <th className="px-5 py-4 text-right text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Action</th>
                </tr>
              </thead>
              ...
              <tbody className="divide-y divide-slate-200">
                {filteredTeams.map((team) => {
                  const head = team.teamHeadUserId;
                  const headLabel = typeof head === 'object' ? head?.name || head?.email || '—' : '—';
