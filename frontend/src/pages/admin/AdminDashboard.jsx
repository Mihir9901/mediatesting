          ...
          <div className="rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-900 px-6 md:px-7 py-7 shadow-lg">
            <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-5">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-3 rounded-2xl border border-white/20 bg-white/5 px-4 py-3 text-white">
                ...
                <button
                  onClick={refresh}
                  className="flex items-center gap-2 rounded-2xl border border-white/20 bg-white/10 hover:bg-white/15 px-5 py-3 text-sm font-bold text-white transition"
                >
                  <RefreshCw className={`w-4 h-4 ${loading ? 'animate-spin' : ''}`} />
                  Refresh
                </button>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
            ...
            <div className="xl:col-span-2 rounded-3xl bg-white border border-slate-200 shadow-sm p-6">
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="flex items-center gap-2">
                  <button className="px-4 py-2 rounded-2xl border border-slate-200 bg-white text-sm font-semibold text-slate-700">
                    This Week
                  </button>
                  <button className="w-11 h-11 rounded-2xl border border-slate-200 bg-white flex items-center justify-center text-slate-600">
                    <Shield className="w-4 h-4" />
                  </button>
                </div>
              </div>
              ...
              <div className="h-[380px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={trend}>
                    <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e9edff" />
                    <XAxis
                      dataKey="day"
                      axisLine={false}
                      tickLine={false}
            ...
            {/* Right panel */}
            <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-6 flex flex-col">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-[15px] font-bold text-slate-900">Present vs absent</p>
                </div>
              </div>

              <div className="h-[245px] rounded-3xl border border-slate-200 flex items-center justify-center">
                {todayShare.length ? (
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
                  ...
                  <div className="text-sm text-slate-500">
                    {loading ? 'Loading insights…' : 'No data for today yet.'}
                  </div>
                )}
              </div>

              <div className="mt-6 rounded-3xl border border-indigo-100 bg-indigo-50 px-4 py-5">
                <p className="text-xs font-black uppercase tracking-widest text-indigo-600">
                  Quick note
                </p>
...
function StatCard({ label, value, helper, icon: Icon, tone }) {
  ...
  return (
    <div className="rounded-3xl bg-white border border-slate-200 shadow-sm px-5 py-6">
