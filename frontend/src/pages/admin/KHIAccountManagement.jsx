  ...
  return (
    <div className="bg-[#f7f8fc] px-4 md:px-6 py-4">
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="relative flex flex-col md:flex-row md:items-end md:justify-between gap-5">
            <div>
              ...
              <p className="mt-2 text-sm font-medium text-indigo-100">
                Securely create, assign, and manage platform credentials across teams.
              </p>
            </div>

            <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-white">
              <p className="text-xs font-semibold text-indigo-100">Active Credentials</p>
        ...
        {error && (
          <div className="rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-rose-800 text-sm font-semibold flex items-center gap-2">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white shadow-sm overflow-visible">
          <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-slate-900">Add New Credentials</h2>
                <p className="text-sm text-slate-500">Create secure platform access for your teams</p>
              </div>
            </div>

            <span className="hidden md:inline-flex items-center gap-2 rounded-2xl bg-indigo-50 border border-indigo-100 px-3 py-2 text-xs font-bold text-indigo-700">
          ...
          <form onSubmit={handleCreateSubmit} className="p-6 md:p-8 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <InputField icon={Globe} label="Platform Name">
                <input
                  type="text"
                  required
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-50"
                />
              </InputField>

              <InputField icon={User} label="Username / ID">
                <input
                  type="text"
                  required
              ...
              <InputField icon={Lock} label="Password">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-12 pr-12 py-3 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-50"
                  />
                  <button
                    type="button"
              ...
              <div className="md:col-span-2 lg:col-span-3">
                <label className="text-[11px] font-bold text-slate-500 uppercase tracking-widest px-1 block mb-2">
                  API Details / Extra Info
                </label>
                <textarea
                  value={formData.apiDetails}
                  onChange={(e) => setFormData({ ...formData, apiDetails: e.target.value })}
                  placeholder="Paste API keys, secret tokens, or notes..."
                  className="w-full min-h-[110px] px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-50"
                />
              </div>

              {/* keep your dropdown logic same here */}
            </div>

            <button
              type="submit"
              disabled={actionLoading}
              className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-bold text-lg shadow-lg shadow-indigo-100 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
            >
        ...
        {/* Keep your existing tables + modals exactly same logic, only wrap them in same card style as previous pages */}
      </div>
    </div>
  );
};
...
const InputField = ({ icon: Icon, label, children }) => (
  <div className="space-y-2">
    <label className="text-[11px] font-bold text-slate-500 uppercase tracking-widest px-1">{label}</label>
    <div className="relative">
